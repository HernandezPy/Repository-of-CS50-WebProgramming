...
class FlightTestCase(TestCase):
    ...
    def setUp(self):
        ...
        a3 = Airport.objects.create(code="CCC", city="CityC")

        # Create flights
        Flight.objects.create(origin=a1, destination=a2, duration=100)
        Flight.objects.create(origin=a2, destination=a3, duration=200)
        Flight.objects.create(origin=a3, destination=a1, duration=300)
    ...
    def test_flight_page_non_passengers(self):
        f = Flight.objects.get(pk=1)
        p = Passenger.objects.create(first="Jane", last="Doe")
